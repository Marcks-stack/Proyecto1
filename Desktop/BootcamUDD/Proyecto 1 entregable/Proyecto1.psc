...
Algoritmo Proyecto_1
	...
	//Calculo final con costo de env�o"
	...
	Si opcion = "1.Nacional" Entonces
        ...
        Escribir "Costo total a pagar con env�o Nacional: ", i
    Sino
		i <- costoFijo + PrecioDescuento + (Peso * Cantidad)
		
        Escribir "Costo total a pagar con env�o Internacional :", i
	...
	Escribir  "Costos total de con  env�o :" i
